...
Honest strongest claim: `Assign physical credit across long horizons without reward labels or RL framing.` is a plausible branch-structured mechanism for robot skill learning, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
