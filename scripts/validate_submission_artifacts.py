...
PAPER = ROOT / "paper"
DOWNLOADS_PDF = Path.home() / "Downloads" / "104.pdf"
DESKTOP_PDF = Path.home() / "Desktop" / "104.pdf"
...
def assert_latex() -> None:
    ...
    required = [
        ...
        "Risk-Calibrated Temporal Credit Without Rewards",
    ]
...
def assert_figures() -> None:
    expected = [
        "temporal_v5_hard_success.png",
        "temporal_v5_diagnostics.png",
        "temporal_v5_safety_regret.png",
        "temporal_v5_stress_sweep.png",
        "temporal_v5_ablation.png",
        "temporal_v5_fixed_risk.png",
    ]
...
def main() -> None:
    ...
    print(f"validated Paper 104 artifacts: pages={pages}, sha256={digest}")
